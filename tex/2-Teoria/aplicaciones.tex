...
\todo[inline,linecolor=red,backgroundcolor=red!25,bordercolor=red]{Aquí se puede profundizar mucho, de hecho en la guía de seguridad que la propia Apple publica \cite{ios-sec-guide} se profundiza mas, pero no se que mas se puede añadir como realmente relevante. Lo mismo, tampoco quiero dar la chapa, sino que se entienda el concepto.}
...
\todo[inline,linecolor=red,backgroundcolor=red!25,bordercolor=red]{Aquí si que vendría mejor, quizás, profundizar un poco más.}
...
\todo[inline,linecolor=red,backgroundcolor=red!25,bordercolor=red]{En esta parte si que parece que le falta algo, o al menos me da a mí la sensación, aunque tampoco quería ser redundante con lo que menciono en el capítulo de malware.}
