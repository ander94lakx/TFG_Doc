...
\begin{listing}[H]
	...
	linenos,
	breaklines
	]{java}{code/install.kt}
	\caption{Función que instala Nmap en el dispositivo}

	\label{code:install}
\end{listing}

Como se puede observar en el código, dentro de la función \mintinline{java}{install()} se realiza ese volcado pudiendo tener opciones para reescribir los archivos en caso de que se quierre escribir. Estos archivos se cargan a través del Asset Manager y mediante las clases de Java para interactuar con ficheros comprimidos se extraen en los ficheros internos de la aplicación.
...
\begin{listing}[H]
	...
	linenos,
	breaklines
	]{java}{code/startProcess.kt}
	\caption{Funcion para arrancar el proceso con la shell que ejecutará Nmap}
